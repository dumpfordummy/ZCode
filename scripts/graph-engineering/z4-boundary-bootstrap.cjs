...
if (
  ...
  throw new Error("Z4 boundary requires this exact freshly isolated profile.");
...
utilityProcess.fork = function (modulePath, args, options) {
  ...
  return originalFork.call(this, path.join(__dirname, "z4-boundary-host.cjs"), args, {
    ...options,
    env: { ...options.env, Z4_GRAPH_BOUNDARY_PROFILE: profile },
  });
};
