...
const zhCN: Record<string, string> = {
  ...
  "graph.status.StaleEvidence": "证据已过期，需重新审阅",
  "graph.status.Approved": "已批准",
  "graph.status.Rejected": "已拒绝",
  "graph.approval.addNode": "添加人工审批",
  "graph.approval.newNode": "人工审批",
  "graph.approval.deleteNode": "删除审批节点及相连边",
  "graph.approval.controlMeaning": "此检查点等待明确的人工决定，不会启动智能体会话。",
  "graph.approval.title": "审批标题",
  "graph.approval.reviewInstructions": "审阅说明",
  "graph.approval.commentPolicy": "决定备注",
  "graph.approval.commentOptional": "备注可选",
  "graph.approval.commentRequired": "必须填写备注",
  "graph.approval.evidenceBindings": "待审阅证据",
  "graph.approval.requiredEvidence":
    "所选证据均为必需项。请至少选择一项；任务证据必须来自路径中更早的任务。",
  "graph.approval.evidenceAlias": "证据名称",
  "graph.approval.evidenceSource": "证据来源",
  "graph.approval.startEvidence": "开始请求",
  "graph.approval.sourceEvidence": "捕获工作区中的源码变更",
  "graph.approval.missingSource": "任务不存在",
  "graph.approval.removeEvidence": "移除证据",
  "graph.approval.addEvidence": "添加必需证据",
  "graph.approval.sourceCoverage":
    "源码证据捕获有范围和大小限制的 Git 变更快照，不包含被忽略的文件或工作区中未变更的文件。不支持、不可读或过大的条目会使证据不完整并阻止批准。",
  "graph.approval.openSourceConversation": "打开来源会话",
  "graph.approval.sourceSession": "来源原生会话",
  "graph.approval.sourceInput": "来源原生输入",
  "graph.approval.sourceCommand": "来源原生命令",
  "graph.approval.evidenceComplete": "证据在所述范围内捕获完整",
  "graph.approval.evidenceIncomplete":
    "证据不完整，无法批准。请取消本次运行，修正证据来源后重新开始。",
  "graph.approval.sourceBaseline": "捕获的 Git 基线",
  "graph.approval.beforeText": "捕获的变更前文本",
  "graph.approval.afterText": "捕获的当前文本",
  "graph.approval.requestPending": "此检查点尚未捕获审阅请求。",
  "graph.approval.staleHelp":
    "证据或图已变化。历史请求保持不变；请取消本次运行并重新开始，以进行新的审阅。",
  "graph.approval.continueHelp":
    "重新打开不会推进此检查点。请明确继续以核验证据和所有权；待审批请求仍需单独作出决定。",
  "graph.approval.decisionSaved": "此决定已保存。历史证据和备注为只读。",
  "graph.approval.decisionBlocked": "当前运行状态不允许对此请求作出决定。",
  "graph.approval.workspace": "捕获的工作区",
  "graph.approval.successor": "预定下一节点",
  "graph.approval.noSuccessor": "无下一节点",
  "graph.approval.requestIdentity": "请求及版本",
  "graph.approval.requestCorrelation": "请求标识及冻结摘要",
  "graph.approval.checkLimit":
    "Host 在接受决定及派发任务前重新检查证据。这不会锁定项目文件，其他编辑器仍可在检查之间修改文件。",
  "graph.approval.retainedDecision":
    "决定的响应尚未确认。原选择、备注和决定标识已保留；请重试相同操作以核对保存结果。",
  "graph.approval.continueApproved": "继续已批准的运行",
  "graph.approval.continueReview": "继续审阅",
  "graph.approval.comment": "备注",
  "graph.approval.approve": "批准",
  "graph.approval.reject": "拒绝",
  "graph.approval.decisionHistory": "已保存的决定",
  "graph.approval.decisionId": "决定标识",
  "graph.approval.actor": "本地操作者",
  "graph.approval.digest": "已审阅请求摘要",
  "graph.approval.actorLimit":
    "此记录标明接受决定的本地 Host 会话，并非经核实的个人身份或防篡改签名。",
  "graph.approval.runCompleted": "运行已完成",
  "graph.approval.completionMeaning":
    "序列已通过所需审批并到达结束节点。请核对保存的证据、会话、文件变更和测试结果，以验证请求的结果。",
  "graph.title": "图工程",
  "graph.backToChat": "返回对话",
  "graph.node.start": "开始",
  "graph.node.end": "结束",
  "graph.scope":
    "开始 → 一至八个智能体任务，可添加人工审批检查点 → 结束。每个任务使用新会话，以及与普通对话相同的原生智能体和工具。",
  "graph.localOnly": "图工程目前仅支持本地工作区。请选择本地工作区后继续。",
  "graph.unavailableHost": "当前 Host 不提供图工程服务，请使用本地构建的桌面应用。",
  "graph.loading": "正在读取图…",
  "graph.refresh": "刷新",
  "graph.name": "图名称",
  "graph.taskName": "智能体任务名称",
  "graph.instructions": "任务指令",
  "graph.layoutHelp":
    "拖动节点，或按 Enter / 空格选中后使用方向键。通过连接点或检查器中的「下一节点」连线。执行顺序由边决定。画布控件提供适应视图。",
  "graph.configuration": "模型与权限配置",
  "graph.selectedModel": "已选模型",
  "graph.reasoning": "推理强度",
  "graph.sharedConfiguration":
    "这里复用普通新对话的模型与权限选择器。每次运行在接纳时固定配置与工作区。",
  "graph.noModel": "请在现有模型设置中选择可用模型。打开本页面不会测试或调用付费模型。",
  "graph.modelSettings": "模型设置",
  "graph.prerequisite":
    "运行图任务前，请在「设置 → 通用」中关闭「提问自动继续」。图工程不会替你修改此设置。",
  "graph.generalSettings": "通用设置",
  "graph.save": "保存图",
  "graph.run": "保存并运行",
  "graph.saving": "正在保存或发送请求…",
  "graph.unsaved": "有未保存的修改",
  "graph.saved": "已保存",
  "graph.conflict":
    "其他编辑器修改了已保存的图。此处仍保留你的未保存内容，请先复制需要保留的文字，再重新载入。",
  "graph.reloadSaved": "放弃本地修改并重新载入已保存的图",
  "graph.runs": "运行记录",
  "graph.noRuns": "暂无运行记录。保存或打开图不会启动智能体任务。",
  "graph.openConversation": "打开对话",
  "graph.cancel": "取消本次任务",
  "graph.completionMeaning": "原生输入已完成。请检查对话、文件修改和测试输出，确认任务结果。",
  "graph.waitingHelp": "打开同一个对话，通过现有权限或问答界面作出回应。",
  "graph.uncertainHelp": "结果尚未确认。当前任务仍被保留，以防重复执行；重新打开不会重发指令。",
  "graph.correlation": "原生会话与固定配置",
  "graph.attempt": "尝试标识",
  "graph.session": "会话标识",
  "graph.input": "输入标识",
  "graph.command": "命令标识",
  "graph.workspace": "固定工作区",
  "graph.inputOwned":
    "图工程持有本次任务。在任务执行中或结果未确认时，不能追加指令或编辑输入。对话下方仍可处理权限与问答请求。",
  "graph.status.Starting": "正在启动",
  "graph.status.Running": "正在运行",
  "graph.status.WaitingForPermission": "等待权限确认",
  "graph.status.WaitingForUser": "等待你的回答",
  "graph.status.CancelRequested": "已请求取消",
  "graph.status.Completed": "输入已完成",
  "graph.status.Failed": "失败",
  "graph.status.Cancelled": "已取消",
  "graph.status.Interrupted": "已中断，结果未确认",
  "graph.status.Unknown": "接纳状态或结果未知",
  "graph.status.Pending": "待执行",
  "graph.status.Skipped": "已跳过",
  "graph.design": "设计",
  "graph.designHelp": "修改仅应用于之后的新运行",
  "graph.frozenRun": "固定运行快照：已提交的定义与配置",
  "graph.inspector": "节点检查器",
  "graph.selectNode": "选择节点",
  "graph.addTask": "添加智能体任务",
  "graph.newTask": "智能体任务",
  "graph.upgrade": "启用顺序编辑",
  "graph.legacyHelp": "此 Z1 图保留字面指令。启用顺序编辑后可添加任务及显式绑定，既有历史不变。",
  "graph.workspaceDefaults": "下一次运行的工作区默认配置",
  "graph.readOnlyHost": "另一 Host 持有此图。仍可查看记录并打开原会话。",
  "graph.notReady": "运行前需要修正草稿",
  "graph.concurrentEdits":
    "所有任务共用此工作区。其他对话及编辑器仍可修改文件，请避免并发编辑。新运行可能重复之前的副作用。",
  "graph.startInput": "开始请求",
  "graph.startHelp": "任务仅通过显式开始绑定接收此文本。",
  "graph.endOutput": "结束结果来源",
  "graph.selectOutput": "选择任务输出",
  "graph.missingSource": "来源不存在",
  "graph.instructionMode": "指令模式",
  "graph.literal": "字面文本",
  "graph.bound": "显式输入绑定",
  "graph.literalHelp": "指令按原文提交。字面模式中的模板标记无特殊含义。",
  "graph.bindingHelp":
    "使用 '{{inputs.alias}}' 插入命名输入，仅替换一次。任务输出必须来自执行路径上已完成的前序任务。",
  "graph.bindingAlias": "输入别名",
  "graph.bindingSource": "输入来源",
  "graph.addBinding": "添加输入绑定",
  "graph.removeBinding": "移除绑定",
  "graph.untrustedHandoff": "绑定文本是不可信的辅助内容。原生权限及信任控制仍适用。",
  "graph.configurationSource": "配置来源",
  "graph.inheritSettings": "继承工作区默认值",
  "graph.overrideSettings": "覆盖此节点配置",
  "graph.settingsFreeze": "运行接纳时统一固定全部任务配置。节点覆盖不会更改普通对话默认值。",
  "graph.planEnabled": "已启用计划",
  "graph.nextNode": "下一节点",
  "graph.disconnected": "未连接",
  "graph.deleteNode": "删除智能体任务及关联边",
  "graph.frozenHelp": "此检查器显示已保存的运行快照。之后的图编辑及对话追问不能改写它。",
  "graph.runResult": "固定运行结果",
  "graph.noOutput": "暂无经确认的输出",
  "graph.runtime": "原始运行时",
  "graph.dispatchPhase": "派发阶段",
  "graph.resolvedInstructions": "解析后的提交指令",
  "graph.notSubmitted": "尚未准备提交指令",
  "graph.instructionTemplate": "固定指令模板",
  "graph.bindingEvidence": "已解析绑定及确切来源标识",
  "graph.finalOutput": "固定最终助手文本",
  "graph.terminalProof": "原生终态及文本归属证据",
  "graph.recovery": "检查并释放所有权",
  "graph.inspectRecovery": "检查原生执行状态",
  "graph.recoveryEvidence": "检查证据",
  "graph.recoveryState.inactive": "已确认停止执行",
  "graph.recoveryState.active": "所持执行仍然活跃",
  "graph.recoveryState.unknown": "尚未确认停止执行",
  "graph.releaseReason": "释放此运行的原因",
  "graph.releaseConfirm":
    "我理解释放所有权会保留未知结果和全部证据，不撤销文件修改，也不启动其他任务。",
  "graph.release": "释放已确认停止的运行",
  "graph.released": "所有权已释放",
  "graph.releaseMeaning": "此审计仅释放图的所有权保护，不代表成功、没有副作用或已回滚。",
  "graph.recoveryBlocked":
    "释放需要权威的停止执行证据。请打开原会话检查确切输入、处理原生交互，或在可用时精准取消。刷新不会重放任务。",
  ...
  "graph.node.tool": "工具",
  "graph.z4.newTool": "工具命令",
  "graph.z4.addTool": "添加工具",
  "graph.z4.artifact": "产物",
  "graph.z4.selector": "产物选择器",
  "graph.z4.pointer": "JSON Pointer（可选）",
  "graph.z4.bindingHelp":
    "选择 final、structured、command、test 或已声明文件路径。/summary 等指针仅选择已验证 JSON 中的字段。证据始终属于确切的已完成尝试。",
  "graph.z4.outputMode": "输出验证",
  "graph.z4.textOutput": "普通最终文本",
  "graph.z4.jsonOutput": "严格 JSON 对象",
  "graph.z4.schema": "本地 JSON 结构",
  "graph.z4.schemaHelp":
    "声明 object 的 properties、required 和 additionalProperties: false。支持字符串、有限数字、布尔值、null、数组及嵌套对象。不支持引用、脚本或自动修复提示，也不改变模型参数。",
  "graph.z4.schemaObject": "请输入 JSON 对象结构；Host 就绪检查将验证支持的关键字。",
  "graph.z4.applySchema": "应用结构",
  "graph.z4.recipes": "项目命令配方",
  ...
  "graph.z4.toolName": "工具节点名称",
  "graph.z4.nodeIdentity": "工具节点 ID",
  "graph.z4.nodeIdentityHelp": "在测试配方的 buildNodeId 中填写前置构建节点的 ID。",
  "graph.z4.recipe": "已配置配方",
  "graph.z4.selectRecipe": "选择已读取的配方",
  "graph.z4.toolHelp":
    "先在上方读取或编辑项目配方。此节点通过原生执行及正常权限审阅运行冻结的命令，模型文本不能更改它。",
  "graph.z4.artifacts": "已捕获产物",
  "graph.z4.inspectContent": "查看保留内容",
  "graph.z4.contentMeaning":
    "这是以纯文本展示的本地观察记录。使用前请检查来源、验证结果及脱敏标记。",
  "graph.z4.exportManifest": "导出元数据清单",
  "graph.z4.manifestHelp": "选择并复制此元数据清单；它不包含原始产物内容。",
  "graph.z4.toolMeaning":
    "进程完成、退出成功、报告新鲜且可解析、验收通过是不同事实。模型声明与人工批准不能替代这些检查。",
  "graph.z4.processStarted": "进程确已启动",
  "graph.z4.processKnown": "进程结果已知",
  "graph.z4.exitSuccessful": "命令退出成功",
  "graph.z4.reportFresh": "测试报告属于本次调用",
  "graph.z4.reportParsed": "测试报告已解析",
  "graph.z4.acceptancePassed": "配置验收规则通过",
  "graph.z4.classification": "验证器类别",
  "graph.z4.counts": "发现 / 通过 / 失败 / 跳过的测试",
  "graph.z4.operation": "冻结配方与原生操作",
  "graph.z4.yes": "是",
  "graph.z4.no": "否",
  "graph.z4.unknown": "尚未确立",
  "graph.z4.notApplicable": "不适用",
  "graph.z4.deleteTool": "删除工具节点及关联边",
  "graph.z5.upgrade": "启用有界路由（v5）",
  "graph.z5.newCondition": "条件",
  "graph.z5.addCondition": "添加条件",
  "graph.z5.deleteCondition": "删除条件及其关联连线",
  "graph.z5.conditionName": "条件名称",
  "graph.z5.conditionHelp":
    "输入绑定声明的产物。按顺序检查分支，首个为真的谓词选择其命名出口，否则选择默认出口。JSON 声明由 Host 验证。",
  "graph.z5.inputs": "输入（JSON 数组）",
  "graph.z5.branches": "有序分支（JSON 数组）",
  "graph.z5.verification": "验证要求（JSON 对象或 null）",
  "graph.z5.defaultExit": "默认出口",
  "graph.z5.errorPolicy": "证据缺失或无效时停止并请求人工处理。",
  "graph.z5.structureError": "请输入有界且有效的条件声明。",
  "graph.z5.applyCondition": "应用条件声明",
  "graph.z5.exit": "命名出口",
  "graph.z5.repairFeedback": "上次修复反馈",
  "graph.z5.feedbackHelp": "仅在声明的修复入口绑定上一迭代的不可变反馈。首次迭代没有修复反馈。",
  "graph.z5.selectNode": "选择节点",
  "graph.z5.routingSettings": "路由与修复限额",
  "graph.z5.finalGate": "最终人工审批节点",
  "graph.z5.maxNodeAdmissions": "最大原生节点执行次数",
  "graph.z5.deadlineMs": "运行期限（毫秒）",
  "graph.z5.budgetHelp":
    "每个已接纳的 Agent Task 或工具操作计数一次，条件和审批不计数。确认运行时由 Host 固定限额；用量与费用不可用。",
  "graph.z5.newRegion": "有界修复区域",
  "graph.z5.enableRegion": "添加有界修复区域",
  "graph.z5.regionName": "区域名称",
  "graph.z5.entryNodeId": "首次入口 Agent Task",
  "graph.z5.repairEntryNodeId": "修复入口 Agent Task",
  "graph.z5.decisionNodeId": "决策条件",
  "graph.z5.bodyNodeIds": "区域节点 ID（每行一个）",
  "graph.z5.sourcePaths": "源文件路径（每行一个相对路径）",
  "graph.z5.repairExit": "修复出口名称",
  "graph.z5.passExit": "通过出口名称",
  "graph.z5.maxRepairIterations": "迭代 0 之后的最大修复次数",
  "graph.z5.noProgress": "未取得进展时停止",
  "graph.z5.regionHelp":
    "仅允许一条声明的修复回边。最终审批位于区域外。使用可见节点 ID 声明区域成员，并在修复入口声明 repair-feedback 输入。",
  "graph.z5.removeRegion": "移除修复区域",
  "graph.z5.routingRun": "路由检查",
  "graph.z5.admissions": "已用原生执行次数 / 上限",
  "graph.z5.deadline": "固定截止时间",
  "graph.z5.usage": "模型用量与费用",
  "graph.z5.usageUnknown": "不可用；未记录估算值",
  "graph.z5.iterations": "迭代、尝试与反馈",
  "graph.z5.checkpoints": "已持久化的路由检查点",
  "graph.z5.continueHelp":
    "仅继续此已验证的检查点。查看运行不会恢复或重放原生工作。未知或中断的原生工作需要保守恢复。",
  "graph.z5.continueRoute": "从检查点继续",
  "graph.z5.successor": "选中的后继节点",
  "graph.z5.evaluatedValues": "已求值数据与产物来源",
  "graph.z5.confirmRun": "确认有界运行",
  "graph.z5.confirmHelp":
    "请检查捕获的图、原生设置和限额。确认后在此工作区启动该快照。后续设计修改不影响已接纳的运行。",
  "graph.z5.capturedDefinition": "捕获的定义与原生设置",
  "graph.z5.backToDesign": "返回设计",
  "graph.z5.iterationAttempt": "迭代与尝试",
  "graph.z5.iteration": "迭代",
  "graph.node.condition": "条件",
  "graph.status.Evaluated": "已求值",
  "graph.status.Invalid": "证据无效",
  "graph.status.NeedsHuman": "需要人工处理",
  "graph.status.BudgetExhausted": "限额已用尽",
  "graph.status.NoProgress": "未取得进展",
  "graph.z5.selectAttempt": "选择已存储的尝试",
  "graph.z6.library": "工作流库",
  "graph.z6.acceptedDecision": "已接受的操作决策",
  "graph.z6.acknowledged": "已确认未知项",
  "graph.z6.notAcknowledged": "未确认未知项",
  "graph.z6.libraryHelp":
    "选择不可变版本，绑定当前工作区，再单独审核运行。工作流库操作不会执行节点。",
  "graph.z6.refresh": "刷新工作流库",
  "graph.z6.libraryRevision": "库修订",
  "graph.z6.workflow": "工作流",
  "graph.z6.chooseWorkflow": "选择工作流",
  "graph.z6.builtin": "内置",
  "graph.z6.archived": "已归档",
  "graph.z6.version": "版本",
  "graph.z6.chooseVersion": "选择版本",
  "graph.z6.duplicateName": "副本名称",
  "graph.z6.duplicate": "复制版本",
  "graph.z6.restore": "恢复",
  "graph.z6.archive": "归档",
  "graph.z6.bindingHelp":
    "参数仅用作明确的运行数据。文件引用必须相对于工作区；技能使用现有原生目录 ID。请先在项目配方编辑器配置命令，再在此选择。",
  "graph.z6.included": "包含",
  "graph.z6.unselected": "未选择",
  "graph.z6.excluded": "排除",
  "graph.z6.skillId": "已有原生技能 ID",
  "graph.z6.relativePath": "工作区相对文件路径",
  "graph.z6.appliesTo": "适用节点",
  "graph.z6.loadRecipes": "加载已有项目配方",
  "graph.z6.unresolved": "未解析绑定",
  "graph.z6.sourcePaths": "修复源路径（每行一个相对路径）",
  "graph.z6.replaceDirty": "用此模板实例替换未保存的草稿。保留已有运行历史。",
  "graph.z6.required": "请填写必需值",
  "graph.z6.instantiate": "实例化所选版本",
  "graph.z6.transfer": "创建、版本、导入与导出",
  "graph.z6.transferHelp":
    "捕获当前设计或粘贴可移植包，然后预览。接受前检查全部 JSON 中的私密指令、路径和密钥。预览不会安装技能、连接服务或执行命令。",
  "graph.z6.name": "模板名称",
  "graph.z6.description": "描述",
  "graph.z6.capture": "预览当前设计",
  "graph.z6.exportPreview": "预览可移植导出",
  "graph.z6.portableJson": "可移植模板 JSON",
  "graph.z6.dryPreview": "验证静态预览",
  "graph.z6.reviewPortable": "我已审阅全部可移植 JSON，并移除不应共享的私密数据。",
  "graph.z6.exportReviewed":
    "导出已审阅：将 JSON 复制到自行选择的文件。本地绑定、对话和执行证据不包含在内。",
  "graph.z6.exportReviewRequired": "分享前请完整审阅导出内容并确认。",
  "graph.z6.create": "创建工作流",
  "graph.z6.saveVersion": "保存所选工作流的新版本",
  "graph.z6.saved": "已保存不可变版本。已有实例与运行保持原版本。",
  "graph.z6.provenance": "冻结的工作流来源",
  "graph.z6.parameters": "参数值",
  "graph.z6.excludedNodes": "明确排除的节点",
  "graph.z6.models": "解析后的主模型目标",
  "graph.z6.auxiliary": "辅助目标",
  "graph.z6.references": "所选源文档与指令引用",
  "graph.z6.inheritedInstructions": "继承的原生指令",
  "graph.z6.nativeEnvironment": "原生技能、插件、钩子及 MCP",
  "graph.z6.environmentHelp": "此处为捕获的配置元数据。未知连接、钩子或外部行为仍保持未知。",
  "graph.z6.recipesPermissions": "命令配方与权限",
  "graph.z6.unknowns": "需要操作决策的未知行为",
  "graph.z6.nativeAccess":
    "原生工具保留正常工作区访问能力。图指令不是文件系统或网络沙箱；本地主模型并不代表所有流量均留在本地。",
  "graph.z6.preflightDigest": "预检摘要",
  "graph.z6.acknowledge":
    "我已审阅工作区、引用、目标、钩子/插件/MCP、命令配方、权限与未知项，并批准本次运行使用该操作配置。",
  "graph.z7.title": "分叉 / 汇合",
  "graph.z7.sequential": "顺序图",
  "graph.z7.enabled": "启用此明确的分叉/汇合计划",
  "graph.z7.name": "工作流名称",
  "graph.z7.request": "已审阅的运行请求",
  "graph.z7.sharedContract": "共享接口与编辑约定",
  "graph.z7.resultRequirements": "结果要求与独立测试",
  "graph.z7.concurrency": "并发工作节点（1 或 2）",
  "graph.z7.deadlineMs": "运行期限（毫秒）",
  "graph.z7.admissionBudget": "原生任务预算（最多 5）",
  "graph.z7.fork": "明确的工作分支",
  "graph.z7.selected": "选择此分支",
  "graph.z7.branchName": "分支名称",
  "graph.z7.instructions": "Agent 任务说明",
  "graph.z7.files": "负责的文件（每行一个相对路径）",
  "graph.z7.additions": "明确允许新增的文件",
  "graph.z7.buildRecipeId": "现有 Build 配方 ID",
  "graph.z7.testRecipeId": "现有 Test 配方 ID（Build 节点：build）",
  "graph.z7.help":
    "工作节点使用干净固定基线的独立应用克隆。原生工具保留完整能力；目录隔离不是操作系统沙箱。结果不会自动集成到原始源码。",
  "graph.z7.topology":
    "批准计划 → 分叉所选工作节点 → 汇合全部所选节点 → 审阅并集成提案 → 组合 Build/Test → 人工最终审阅",
  "graph.z7.design": "设计",
  "graph.z7.runs": "并行运行",
  "graph.z7.refresh": "刷新",
  "graph.z7.unavailable": "此 Host 不支持分叉/汇合。",
  "graph.z7.configuration": "现有原生模型与权限",
  "graph.z7.recipesHelp":
    "请先在顺序图的项目配方编辑器配置真实 Build/Test。不会自动复制或安装依赖与缺失工具。",
  "graph.z7.save": "保存计划",
  "graph.z7.preview": "预览基线与配置",
  "graph.z7.prepareAck":
    "我批准按所示配置、集成及未知项创建应用克隆并初始化原生运行时。下一次计划批准之前不会提交 Agent 输入。",
  "graph.z7.prepare": "准备应用工作区",
  "graph.z7.empty": "暂无并行运行。",
  "graph.z7.phase.Preparing": "正在准备工作区",
  "graph.z7.phase.Prepared": "等待计划批准",
  "graph.z7.phase.Workers": "所选工作节点执行中",
  "graph.z7.phase.JoinReview": "汇合完成 — 审阅集成",
  "graph.z7.phase.Integrating": "正在集成已审阅提案",
  "graph.z7.phase.Validating": "组合验证与最终审阅",
  "graph.z7.phase.Completed": "组合结果已批准",
  "graph.z7.phase.Stopped": "已停止 — 检查保留的工作",
  "graph.z7.phase.Interrupted": "已中断 — 不会自动重放",
  "graph.z7.admissions": "准入次数",
  "graph.z7.skipped": "已跳过",
  "graph.z7.pending": "待执行",
  "graph.z7.openConversation": "打开现有对话",
  "graph.z7.inventory": "捕获的原生目标与配置",
  "graph.z7.proposal": "完整提议变更",
  "graph.z7.frozen": "冻结的计划、基线与决定",
  "graph.z7.comment": "审阅 / 审计说明",
  "graph.z7.conflict": "为此冲突文件选择已审阅提案",
  "graph.z7.choose": "请明确选择",
  "graph.z7.reviewAck":
    "我已审阅确切基线、工作区范围、原生权限和配置、未知项及所有提案。本决定不授权发布或修改原始工作区。",
  "graph.z7.approvePlan": "批准计划并启动所选工作节点",
  "graph.z7.approveIntegration": "批准所选集成",
  "graph.z7.reject": "拒绝并停止",
  "graph.z7.cancel": "取消拥有的工作",
  "graph.z7.inspect": "检查恢复状态",
  "graph.z7.release": "释放已确认静止的运行",
  "graph.z7.retention": "工作区保留与清理",
  "graph.z7.cleanupHelp":
    "默认保留工作区。清理要求运行已停止或完成、确认静止、所有权确切且无活动原生运行时。标记保留的工作区不可删除。",
  "graph.z7.preserve": "保留此工作区",
  "graph.z7.cleanup": "删除此静止的应用工作区",
  "graph.z7.cleaned": "已清理",
};
