...
const enUS: Record<string, string> = {
  ...
  "graph.status.StaleEvidence": "Stale evidence — new review required",
  "graph.status.Approved": "Approved",
  "graph.status.Rejected": "Rejected",
  "graph.approval.addNode": "Add Human Approval",
  "graph.approval.newNode": "Human Approval",
  "graph.approval.deleteNode": "Delete approval and incident edges",
  "graph.approval.controlMeaning":
    "This checkpoint waits for an explicit human decision. It does not start an agent session.",
  "graph.approval.title": "Approval title",
  "graph.approval.reviewInstructions": "Review instructions",
  "graph.approval.commentPolicy": "Decision comment",
  "graph.approval.commentOptional": "Optional comment",
  "graph.approval.commentRequired": "Comment required",
  "graph.approval.evidenceBindings": "Evidence to review",
  "graph.approval.requiredEvidence":
    "Every selected evidence item is required. Select at least one; task evidence must come from an earlier task on the path.",
  "graph.approval.evidenceAlias": "Evidence name",
  "graph.approval.evidenceSource": "Evidence source",
  "graph.approval.startEvidence": "Start request",
  "graph.approval.sourceEvidence": "Source changes in captured workspace",
  "graph.approval.missingSource": "Missing task",
  "graph.approval.removeEvidence": "Remove evidence",
  "graph.approval.addEvidence": "Add required evidence",
  "graph.approval.sourceCoverage":
    "Source evidence captures a bounded Git change snapshot. Ignored files and unchanged workspace files are outside this scope. Unsupported, unreadable or oversized entries make evidence incomplete and block approval.",
  "graph.approval.openSourceConversation": "Open source conversation",
  "graph.approval.sourceSession": "Source native session",
  "graph.approval.sourceInput": "Source native input",
  "graph.approval.sourceCommand": "Source native command",
  "graph.approval.evidenceComplete": "Evidence capture complete within stated scope",
  "graph.approval.evidenceIncomplete":
    "Evidence is incomplete. Approval is blocked; cancel this run and start a new run after correcting the evidence source.",
  "graph.approval.sourceBaseline": "Captured Git baseline",
  "graph.approval.beforeText": "Captured previous text",
  "graph.approval.afterText": "Captured current text",
  "graph.approval.requestPending": "This checkpoint has not captured a review request yet.",
  "graph.approval.staleHelp":
    "The evidence or graph has changed. The historical request is preserved; cancel this run and start a new run for a new review.",
  "graph.approval.continueHelp":
    "Reopening never advances this checkpoint. Use Continue to verify the saved evidence and ownership; a pending request still needs a separate decision.",
  "graph.approval.decisionSaved":
    "This decision is saved. Historical evidence and comments are read-only.",
  "graph.approval.decisionBlocked":
    "This request cannot accept a decision in the current run state.",
  "graph.approval.workspace": "Captured workspace",
  "graph.approval.successor": "Intended next node",
  "graph.approval.noSuccessor": "No next node",
  "graph.approval.requestIdentity": "Request and version",
  "graph.approval.requestCorrelation": "Request identity and frozen digests",
  "graph.approval.checkLimit":
    "The Host rechecks evidence before accepting a decision and dispatching work. This does not lock project files; another editor can change them between checks.",
  "graph.approval.retainedDecision":
    "The response to your decision is unconfirmed. Its choice, comment and decision ID are retained; retry the same action to reconcile the saved result.",
  "graph.approval.continueApproved": "Continue approved run",
  "graph.approval.continueReview": "Continue to review",
  "graph.approval.comment": "Comment",
  "graph.approval.approve": "Approve",
  "graph.approval.reject": "Reject",
  "graph.approval.decisionHistory": "Saved decision",
  "graph.approval.decisionId": "Decision ID",
  "graph.approval.actor": "Local actor",
  "graph.approval.digest": "Reviewed request digest",
  "graph.approval.actorLimit":
    "This records the local Host session that accepted the decision. It is not verified personal identity or a tamperproof signature.",
  "graph.approval.runCompleted": "Run completed",
  "graph.approval.completionMeaning":
    "The sequence reached End with its required approvals. Check the saved evidence, conversations, file changes and test results for the requested outcome.",
  "graph.title": "Graph Engineering",
  "graph.backToChat": "Back to chat",
  "graph.node.start": "Start",
  "graph.node.end": "End",
  "graph.scope":
    "Start → one to eight Agent Tasks with optional Human Approval checkpoints → End. Each task uses a fresh session of the same native agent and tools as chat.",
  "graph.localOnly":
  ...
  "graph.z4.newTool": "Tool command",
  "graph.z4.addTool": "Add Tool",
  "graph.z4.artifact": "Artifact",
  "graph.z4.selector": "Artifact selector",
  "graph.z4.pointer": "JSON Pointer (optional)",
  "graph.z4.bindingHelp":
    "Select final, structured, command, test, or a declared file path. A pointer such as /summary selects only validated JSON. Evidence belongs to the exact completed attempt.",
  "graph.z4.outputMode": "Output validation",
  "graph.z4.textOutput": "Normal final text",
  "graph.z4.jsonOutput": "Strict JSON object",
  "graph.z4.schema": "Local JSON schema",
  "graph.z4.schemaHelp":
    "Declare object properties and required fields with additionalProperties: false. Strings, finite numbers, booleans, null, arrays and nested objects are supported. No references, scripts, repair prompts or provider parameter changes.",
  "graph.z4.schemaObject":
    "Enter a JSON object schema. Host readiness validates its supported keywords.",
  "graph.z4.applySchema": "Apply schema",
  "graph.z4.recipes": "Project command recipes",
  ...
  "graph.z4.toolName": "Tool node name",
  "graph.z4.nodeIdentity": "Tool node ID",
  "graph.z4.nodeIdentityHelp": "Use the earlier Build node's ID as buildNodeId in a Test recipe.",
  "graph.z4.recipe": "Configured recipe",
  "graph.z4.selectRecipe": "Select a loaded recipe",
  "graph.z4.toolHelp":
    "Load or edit project recipes above. This node runs the frozen configured command through native execution and normal permission review; model text cannot change it.",
  "graph.z4.artifacts": "Captured artifacts",
  "graph.z4.inspectContent": "Inspect retained content",
  "graph.z4.contentMeaning":
    "Captured local observation, displayed as text. Check provenance, validation and redaction before relying on it.",
  "graph.z4.exportManifest": "Export metadata manifest",
  "graph.z4.manifestHelp":
    "Select and copy this metadata-only manifest. Raw artifact content is excluded.",
  "graph.z4.toolMeaning":
    "Process completion, successful exit, fresh parsed evidence and acceptance are separate facts. Agent claims and graph approval do not replace these checks.",
  "graph.z4.processStarted": "Process actually started",
  "graph.z4.processKnown": "Process outcome known",
  "graph.z4.exitSuccessful": "Command exit successful",
  "graph.z4.reportFresh": "Test report is fresh",
  "graph.z4.reportParsed": "Test report parsed",
  "graph.z4.acceptancePassed": "Configured acceptance passed",
  "graph.z4.classification": "Verifier classification",
  "graph.z4.counts": "Discovered / passed / failed / skipped tests",
  "graph.z4.operation": "Frozen recipe and native operation",
  "graph.z4.yes": "Yes",
  "graph.z4.no": "No",
  "graph.z4.unknown": "Not established",
  "graph.z4.notApplicable": "Not applicable",
  "graph.z4.deleteTool": "Delete Tool and incident edges",
  "graph.z5.upgrade": "Enable bounded routing (v5)",
  "graph.z5.newCondition": "Condition",
  "graph.z5.addCondition": "Add Condition",
  "graph.z5.deleteCondition": "Delete Condition and incident edges",
  "graph.z5.conditionName": "Condition name",
  "graph.z5.conditionHelp":
    "Inputs bind declared artifacts. Branches are checked in order; the first true predicate selects its named exit, otherwise the default exit is selected. JSON declarations are validated by the Host.",
  "graph.z5.inputs": "Inputs (JSON array)",
  "graph.z5.branches": "Ordered branches (JSON array)",
  "graph.z5.verification": "Verification requirements (JSON object or null)",
  "graph.z5.defaultExit": "Default exit",
  "graph.z5.errorPolicy": "Missing or invalid evidence stops for human review.",
  "graph.z5.structureError": "Enter bounded, valid Condition declarations.",
  "graph.z5.applyCondition": "Apply Condition declarations",
  "graph.z5.exit": "Named exit",
  "graph.z5.repairFeedback": "Previous repair feedback",
  "graph.z5.feedbackHelp":
    "Binds the immutable feedback from the previous iteration only at the declared repair entry. The first iteration has no repair feedback.",
  "graph.z5.selectNode": "Select a node",
  "graph.z5.routingSettings": "Routing and repair limits",
  "graph.z5.finalGate": "Final human approval gate",
  "graph.z5.maxNodeAdmissions": "Maximum native node admissions",
  "graph.z5.deadlineMs": "Run deadline (milliseconds)",
  "graph.z5.budgetHelp":
    "Each admitted Agent Task or Tool operation counts once. Conditions and approvals do not. The Host freezes these limits when you confirm Run; usage and cost are unavailable.",
  "graph.z5.newRegion": "Bounded repair region",
  "graph.z5.enableRegion": "Add bounded repair region",
  "graph.z5.regionName": "Region name",
  "graph.z5.entryNodeId": "Initial entry Agent Task",
  "graph.z5.repairEntryNodeId": "Repair entry Agent Task",
  "graph.z5.decisionNodeId": "Decision Condition",
  "graph.z5.bodyNodeIds": "Region node IDs (one per line)",
  "graph.z5.sourcePaths": "Source paths (one relative path per line)",
  "graph.z5.repairExit": "Repair exit name",
  "graph.z5.passExit": "Pass exit name",
  "graph.z5.maxRepairIterations": "Maximum repair iterations after iteration 0",
  "graph.z5.noProgress": "Stop when no progress is established",
  "graph.z5.regionHelp":
    "One declared repair back-edge is allowed. Keep the final approval outside the region. Region membership uses the visible node IDs. Declare the repair-feedback input at the repair entry.",
  "graph.z5.removeRegion": "Remove repair region",
  "graph.z5.routingRun": "Routing inspection",
  "graph.z5.admissions": "Native admissions used / maximum",
  "graph.z5.deadline": "Frozen deadline",
  "graph.z5.usage": "Model usage and cost",
  "graph.z5.usageUnknown": "Unavailable; no estimate is recorded",
  "graph.z5.iterations": "Iterations, attempts and feedback",
  "graph.z5.checkpoints": "Persisted route checkpoints",
  "graph.z5.continueHelp":
    "Continue only this verified checkpoint. Viewing this run does not resume or replay native work. Unknown or interrupted native work requires conservative recovery.",
  "graph.z5.continueRoute": "Continue from checkpoint",
  "graph.z5.successor": "Selected successor",
  "graph.z5.evaluatedValues": "Evaluated values and artifact provenance",
  "graph.z5.confirmRun": "Confirm bounded run",
  "graph.z5.confirmHelp":
    "Review the captured graph, native settings and limits. Confirm starts this exact snapshot in this workspace. Later design edits do not change an accepted run.",
  "graph.z5.capturedDefinition": "Captured definition and native settings",
  "graph.z5.backToDesign": "Back to design",
  "graph.z5.iterationAttempt": "Iteration and attempt",
  "graph.z5.iteration": "Iteration",
  "graph.node.condition": "Condition",
  "graph.status.Evaluated": "Evaluated",
  "graph.status.Invalid": "Invalid evidence",
  "graph.status.NeedsHuman": "Needs human review",
  "graph.status.BudgetExhausted": "Budget exhausted",
  "graph.status.NoProgress": "No progress",
  "graph.z5.selectAttempt": "Select a stored attempt",
  "graph.z6.library": "Workflow library",
  "graph.z6.acceptedDecision": "Accepted operational decision",
  "graph.z6.acknowledged": "Unknowns acknowledged",
  "graph.z6.notAcknowledged": "Unknowns not acknowledged",
  "graph.z6.libraryHelp":
    "Choose an immutable version, bind it to this workspace, and review the run separately. Library actions never execute nodes.",
  "graph.z6.refresh": "Refresh library",
  "graph.z6.libraryRevision": "Library revision",
  "graph.z6.workflow": "Workflow",
  "graph.z6.chooseWorkflow": "Choose a workflow",
  "graph.z6.builtin": "Built-in",
  "graph.z6.archived": "Archived",
  "graph.z6.version": "Version",
  "graph.z6.chooseVersion": "Choose a version",
  "graph.z6.duplicateName": "Name for duplicate",
  "graph.z6.duplicate": "Duplicate version",
  "graph.z6.restore": "Restore",
  "graph.z6.archive": "Archive",
  "graph.z6.bindingHelp":
    "Values are explicit run data. File references are workspace-relative; skills use existing native catalog IDs. Configure recipes through the existing Project recipes editor before selecting them here.",
  "graph.z6.included": "Included",
  "graph.z6.unselected": "Not selected",
  "graph.z6.excluded": "Excluded",
  "graph.z6.skillId": "Existing native skill ID",
  "graph.z6.relativePath": "Workspace-relative file path",
  "graph.z6.appliesTo": "Applies to nodes",
  "graph.z6.loadRecipes": "Load existing project recipes",
  "graph.z6.unresolved": "Unresolved bindings",
  "graph.z6.sourcePaths": "Repair source paths (one relative path per line)",
  "graph.z6.replaceDirty":
    "Replace my unsaved draft with this template instance. Existing run history will remain.",
  "graph.z6.required": "Complete required values",
  "graph.z6.instantiate": "Instantiate selected version",
  "graph.z6.transfer": "Create, version, import and export",
  "graph.z6.transferHelp":
    "Capture the current design or paste a portable package, then preview it. Inspect all JSON for private instructions, paths and secrets before accepting. Preview does not install skills, connect services or execute commands.",
  "graph.z6.name": "Template name",
  "graph.z6.description": "Description",
  "graph.z6.capture": "Preview current design",
  "graph.z6.exportPreview": "Preview portable export",
  "graph.z6.portableJson": "Portable template JSON",
  "graph.z6.dryPreview": "Validate dry preview",
  "graph.z6.reviewPortable":
    "I reviewed the entire portable JSON and removed private data that must not be shared.",
  "graph.z6.exportReviewed":
    "Reviewed export: copy the JSON into a file you choose. Local bindings, conversations and execution evidence are excluded.",
  "graph.z6.exportReviewRequired": "Review the full export and acknowledge before sharing it.",
  ...
  "graph.z6.models": "Resolved primary destinations",
  "graph.z6.auxiliary": "Auxiliary destinations",
  "graph.z6.references": "Selected source and instruction references",
  "graph.z6.inheritedInstructions": "Inherited native instructions",
  "graph.z6.nativeEnvironment": "Native skills, plugins, hooks and MCP",
  "graph.z6.environmentHelp":
    "This is captured configuration metadata. Unknown connection, hook or external behavior remains unknown.",
  "graph.z6.recipesPermissions": "Command recipes and permissions",
  "graph.z6.unknowns": "Unknown behavior requiring an operational decision",
  "graph.z6.nativeAccess":
    "Native tools retain normal workspace access. Graph prompts are not a filesystem or network sandbox; a local primary model does not prove all traffic stays local.",
  "graph.z6.preflightDigest": "Preflight digest",
  "graph.z6.acknowledge":
    "I reviewed the workspace, references, destinations, hooks/plugins/MCP, command recipes, permissions and Unknowns, and approve this operational configuration for this run.",
  "graph.z7.title": "Fork / Join",
  "graph.z7.sequential": "Sequential graph",
  "graph.z7.enabled": "Enable this explicit Fork/Join plan",
  "graph.z7.name": "Workflow name",
  "graph.z7.request": "Approved run request",
  "graph.z7.sharedContract": "Shared interfaces and edit contract",
  "graph.z7.resultRequirements": "Required results and independent tests",
  "graph.z7.concurrency": "Concurrent workers (1 or 2)",
  "graph.z7.deadlineMs": "Run deadline (milliseconds)",
  "graph.z7.admissionBudget": "Native admission budget (maximum 5)",
  "graph.z7.fork": "Explicit worker branches",
  "graph.z7.selected": "Selected branch",
  "graph.z7.branchName": "Branch name",
  "graph.z7.instructions": "Agent task instructions",
  "graph.z7.files": "Owned files (one relative path per line)",
  "graph.z7.additions": "Explicitly approved new files",
  "graph.z7.buildRecipeId": "Existing Build recipe ID",
  "graph.z7.testRecipeId": "Existing Test recipe ID (Build node: build)",
  "graph.z7.help":
    "Workers use separate owned local clones of a clean pinned base. Native tools remain fully capable; directory separation is not an OS sandbox. Original source is never automatically integrated.",
  "graph.z7.topology":
    "Approve plan → Fork selected workers → Join all selected → Review and integrate proposals → Combined Build/Test → Human final review",
  "graph.z7.design": "Design",
  "graph.z7.runs": "Parallel runs",
  "graph.z7.refresh": "Refresh",
  "graph.z7.unavailable": "This Host does not provide Fork/Join.",
  "graph.z7.configuration": "Existing native model and permissions",
  "graph.z7.recipesHelp":
    "Configure real project recipes in the sequential Graph Project recipes editor first. Dependencies and missing tooling are not copied or installed automatically.",
  "graph.z7.save": "Save plan",
  "graph.z7.preview": "Preview base and configuration",
  "graph.z7.prepareAck":
    "I approve creating these owned clones and initializing their native runtimes under the displayed configuration, integrations and Unknowns. No Agent input starts until the next plan approval.",
  "graph.z7.prepare": "Prepare owned workspaces",
  "graph.z7.empty": "No parallel runs yet.",
  "graph.z7.phase.Preparing": "Preparing workspaces",
  "graph.z7.phase.Prepared": "Awaiting plan approval",
  "graph.z7.phase.Workers": "Selected workers active",
  "graph.z7.phase.JoinReview": "Join complete — review integration",
  "graph.z7.phase.Integrating": "Integrating reviewed proposals",
  "graph.z7.phase.Validating": "Combined verification and final review",
  "graph.z7.phase.Completed": "Combined result approved",
  "graph.z7.phase.Stopped": "Stopped — inspect retained work",
  "graph.z7.phase.Interrupted": "Interrupted — no automatic replay",
  "graph.z7.admissions": "Admissions",
  "graph.z7.skipped": "Skipped",
  "graph.z7.pending": "Pending",
  "graph.z7.openConversation": "Open existing conversation",
  "graph.z7.inventory": "Captured native destinations and configuration",
  "graph.z7.proposal": "Complete proposed changes",
  "graph.z7.frozen": "Frozen plan, base and decisions",
  "graph.z7.comment": "Review / audit comment",
  "graph.z7.conflict": "Choose the reviewed proposal for this conflicting file",
  "graph.z7.choose": "Choose explicitly",
  "graph.z7.reviewAck":
    "I reviewed exact base, workspace scopes, native permissions/configuration, Unknowns and all proposals. This decision does not authorize publication or modify the original workspace.",
  "graph.z7.approvePlan": "Approve plan and start selected workers",
  "graph.z7.approveIntegration": "Approve selected integration",
  "graph.z7.reject": "Reject and stop",
  "graph.z7.cancel": "Cancel owned work",
  "graph.z7.inspect": "Inspect recovery",
  "graph.z7.release": "Release confirmed-inactive run",
  "graph.z7.retention": "Workspace retention and cleanup",
  "graph.z7.cleanupHelp":
    "Workspaces are retained by default. Cleanup requires a stopped/completed run, confirmed inactivity, exact ownership and no active native runtime. Preserved workspaces cannot be deleted.",
  "graph.z7.preserve": "Preserve this workspace",
  "graph.z7.cleanup": "Delete this inactive owned workspace",
  "graph.z7.cleaned": "Cleaned",
};
